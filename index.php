             ...
             <h1 class="name"><?php echo $_SESSION['username']; ?></h1>
                    ...
                    <?php
                         ...
                         if($age>18) {
                              ...
                              echo "<h4 class='polling'> Your polling station is: </h4>";
